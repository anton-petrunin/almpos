...
$[h\circ f]-[f]=[\beta]\in \mathrm{Tor}(\pi_2F)$.
\end{techlem}

\begin{proof}[Proof.] Assume contrary. Then it the correspondent derivation 
...
$$f'\colon F\times \DD\to F\times \DD $$ uniquely described by identity
...
Sinse the bundle is trivial over ${\Bbb S}^1$,
