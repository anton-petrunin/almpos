...
\def\sectionthree{ Section \ref{sec:constr} }
\def\kpt{}
...
The proof is surprisingly involved.
If you see an other proof please share it with us --- it might lead to the solution of the main conjecture\kpt.
...
let us assume that \emph{all the Alexandrov spaces $A_i$ which appear in the construction in  \sectionthree 
for all possible choices of base points are closed Riemannian manifolds}.
...
However, we have not worked out the details of the proof as we do not see a  geometric condition which would imply such assumption on $A_i$.%We see a technical way to make a reduction.
