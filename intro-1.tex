...
The following topological result is motivated by Conjecture~\ref{con:tor} in the next section.
...
An approach to studying almost nonnegatively curved manifolds is by studying successive blow-ups of the collapsing sequence $M_n=(M,g_n)$ as done in \cite[Section 4.3]{KPT} which we are about to describe.
...
Now let us assume that for all choices of the sequence $\bar p_n\in M_n$
