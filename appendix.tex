...
We would be interested to see a proof based on a different idea;
...
Then we can homotop $h'$ to a single $\mathbb{S}^1$-fiber, and this easily gives the needed map of  a solid torus.
