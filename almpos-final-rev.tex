...
Consider a horizontal section of $E'$ over $\partial \DD\times \S^1$ with respect to ~\eqref{triv2}. Fix $w\in \mathbb{S}^1$. This gives a horizontal with respect to ~\eqref{triv2} section over $\partial \DD\times w$.
Since 
